function settings() {
  ...
  this.initialize = function() {
    ...
    //nearby_stolen
    $('#' + 'nearby_stolen' + '-' + 0).click(function(){Tracker.settings.changeSetting('nearby_stolen', 0);});
    $('#' + 'nearby_stolen' + '-' + 1).click(function(){Tracker.settings.changeSetting('nearby_stolen', 1);});
    $('#' + 'nearby_stolen' + '-' + 2).click(function(){Tracker.settings.changeSetting('nearby_stolen', 2);});
    $('#' + 'nearby_stolen' + '-' + 3).click(function(){Tracker.settings.changeSetting('nearby_stolen', 3);});
     //stolen
    $('#' + 'stolen' + '-' + 0).click(function(){Tracker.settings.changeSetting('stolen', 0);});
    $('#' + 'stolen' + '-' + 1).click(function(){Tracker.settings.changeSetting('stolen', 1);});
    $('#' + 'stolen' + '-' + 2).click(function(){Tracker.settings.changeSetting('stolen', 2);});
    $('#' + 'stolen' + '-' + 3).click(function(){Tracker.settings.changeSetting('stolen', 3);});
    //disturbed
    $('#' + 'disturbed' + '-' + 0).click(function(){Tracker.settings.changeSetting('disturbed', 0);});
    $('#' + 'disturbed' + '-' + 1).click(function(){Tracker.settings.changeSetting('disturbed', 1);});
    $('#' + 'disturbed' + '-' + 2).click(function(){Tracker.settings.changeSetting('disturbed', 2);});
    $('#' + 'disturbed' + '-' + 3).click(function(){Tracker.settings.changeSetting('disturbed', 3);});

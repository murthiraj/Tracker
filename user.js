...
/////////////////////////////////////////////
  this.signUp = function (username, password, name, email, phone) {
    ...
    User.signUp(null, {
      success: function(user) {
        ...
        Tracker.registration.goToLogin();
      },
  ...
  this.updateUser = function(name, email, phone) {
    Tracker.user.currentUser().set("name", name);
    Tracker.user.currentUser().set("email", email);
    Tracker.user.currentUser().set("phone", phone);
  };

  this.addVehicle = function (license, make, model, year, others, successFun, errorFun)
  {
    var userId = Tracker.user.currentUser().id;

function profile() {
	...
	this.initialize = function() {
		var User = Tracker.user.currentUser();
      ...
      Tracker.image_upload.newPicture(onPicSuccess)});
		$('#logout-button').click(function(){Trackerr.user.logout()});
		$('#save-button').click(function(){Tracker.profile.saveProfile()});
	}
